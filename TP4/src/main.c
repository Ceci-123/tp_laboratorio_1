...
int main(void)
{
    //harcodeo mascotas para pruebas
    eMascota m1 = {1234,"Bobby",'m',2};
    eMascota m2 = {1023,"Lola",'h',1};
    eMascota m3 = {1856,"Bunny",'m',5};
    eMascota m4 = {1322,"Morena",'h',10};
    eMascota m5 = {1872,"Milo",'m',6};
    eMascota m6 = {1654,"Lady",'h',1};
    ...
    printf("El indice donde esta Bobby es %d \n ", indice);
    auxiliar = ll_contains(lista,puntero);
    printf("\n");
    printf("--**-- Uso de ll_contains --**--\n");
    printf("Determino si la lista contiene un elemento\n");
    printf("La lista contiene a Bobby, entonces el valor q devuelve contains es %d \n ", auxiliar);
    printf("\n");
